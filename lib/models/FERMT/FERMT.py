...
from lib.models.FERMT.kat_channel import ChannelKat


class OSTrack(nn.Module):
    """ This is the base class for OSTrack """

    def __init__(self, transformer, box_head, aux_loss=False, head_type="CORNER", channel_dim=192):
        ...
        self.kat_channel = ChannelKat(channel=channel_dim)
    ...
    def forward_head(self, cat_feature, gt_score_map=None):
        ...
        enc_opt = self.kat_channel(enc_opt, self.feat_sz_s) + enc_opt
